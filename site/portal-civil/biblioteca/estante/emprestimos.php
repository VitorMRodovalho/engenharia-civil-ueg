...
*/
    ...
    {
      $DB_BASE=$DB_BASE.
               " AND LEFT(b.tx_titulo_livro,1)=\"".$MI_LBAR[$MI_LETR]."\"";
    }
    elseif ( $MI_LETR==2 )
    {
      $DB_BASE=$DB_BASE.
    ...
    if ( $MI_LETR>0 )
    {
      ...
      if ( $DB_SQL0 )
      {
        ...
        {
          print display_message("N&atilde;o existem livros emprestados ".
                "em &quot;".$MI_LBAR[$MI_LETR]."&quot;");
        }
      }
      else
    ...
    if ( $MI_SEGV>0 )
    {
      ...
      switch($EM_EMPR)
      {
        ...
        $DB_BASE="SELECT id_emprestimo FROM tb_bibengc_emprestimos ".
        ...
        if ( $DB_SQL0 )
        {
          if ( db_num_rows($DB_SQL0)>0 )
          {
            ...
            if ( $DB_SQL1 )
            {
              ...
              $DB_BASE="INSERT INTO tb_bibengc_historicos (".
              ...
              $DB_BASE="DELETE FROM tb_bibengc_emprestimos ".
