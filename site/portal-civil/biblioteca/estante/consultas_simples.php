  ...
  switch( $MI_LETR )
  {
    ...
    */
    $RE_SQLS=array("",
		   ...
		   "FROM tb_bibengc_emprestimos",
                   "SELECT COUNT(id_livro) AS s ".
		   "FROM tb_bibengc_livros WHERE st_status_livro<>'D'",
                   "SELECT COUNT(id_usuario) AS s ".
		   "FROM tb_bibengc_usuarios WHERE st_status_usuario='A'",
		   "SELECT COUNT(id_usuario) AS s ".
		   "FROM tb_bibengc_usuarios WHERE st_status_usuario='B'",
		   "",
 	           "SELECT COUNT(id_emprestimo) AS s ".
		   "FROM tb_bibengc_emprestimos WHERE dt_fim_emprestimo='".$MI_TDAY."'",
		   "SELECT COUNT(id_emprestimo) AS s ".
		   "FROM tb_bibengc_emprestimos WHERE dt_fim_emprestimo<'".$MI_TDAY."'",
     	           "SELECT COUNT(id_historico) AS s ".
		   "FROM tb_bibengc_historicos");
    ...
    */
    print "<td colspan='4'>".
          "<h3>OS DEZ USU&Aacute;RIOS MAIS FREQUENTES</h3>\n";
