...
*/
  ...
  switch ( $MI_ACTN )
  {
    ...
    */
    ...
    print
    show_letterbar($MI_OPTN,$MI_ACTN,$MI_REGI,$MI_SORT,$MI_EDIT,$MI_LETR);
    ...
    $DB_BASE="SELECT".
	     ...
	     "FROM tb_bibengc_usuarios ".
	     "WHERE st_status_usuario<>'D' ";

    if ( $MI_LETR>2 )
    {
      $DB_BASE=$DB_BASE.
               " AND LEFT(tx_nome_usuario,1)=\"".$MI_LBAR[$MI_LETR]."\"";
    }
    elseif ( $MI_LETR==2 )
    {
      $DB_BASE=$DB_BASE.
               " AND LEFT(tx_nome_usuario,1) BETWEEN \"0\" AND \"9\"";
    }
    ...
    */
	...
	if ( $MI_CONT>0 )
	{
	  print display_message("J&aacute; existe um usu&aacute;rio com ".
	        "este n&uacute;mero de documento!");

	  include("formulario_usuario.php");	
	}
	else
	{
	  $DB_SQL1="INSERT INTO tb_bibengc_usuarios ".
    ...
    */
    ...
    if ( $DB_CONT==1 )
    {
      ...
      list( $US_NOME, $US_DOCU, $US_NASC,
            $US_ESCO, $US_SEXO, $US_TRES,
	    $US_TCEL, $US_TCOM, $US_STAT  ) = $DB_LINE;
	...
	else
	{
	  ...
	  $DB_BASE="UPDATE tb_bibengc_usuarios SET ".
	           format_in_equals(
	           array(
		   "tx_nome_usuario","tx_doc_usuario",
		   "dt_nasc_usuario","st_sexo_usuario",
    ...
    */
    ...
    if ( $DB_CONT==1 )
    {
      ...
      $DB_BASE="SELECT".
	       ...
	       "FROM".
	       " tb_bibengc_historicos AS a,".
	       " tb_bibengc_livros AS b ".
	       "WHERE".
    ...
    */
    ...
    if ( $DB_CONT==1 )
    {
      ...
      {
        /*
	eu não posso apagar um usuário enquanto ele tiver livros com ele
	*/
        $DB_BASE="SELECT".
	         " id_emprestimo ".
		 "FROM".
