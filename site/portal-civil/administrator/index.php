...
if (isset( $_POST['submit'] )) {
	...
	if (@$my->id) {
		...
		mosErrorAlert("Erro no nome do usuário ou senha.  Por favor, verifique os dados introduzidos e tente novamente", "document.location.href='index.php?mosmsg=Incorrect Username, Password. Please try again'");
	}
} else {
	initGzip();
