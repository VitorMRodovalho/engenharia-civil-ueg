		...
		?>
			...
			<tr>
				<td>
					...
					?>
          NOTA 1: Para alterar as permissões aceda ao site por FTP e faça CHMOD. Tenha em atenção que, em execução normal do site, alguns directórios devem estar como não editáveis.<br />
          NOTA 2: CHMOD 777 torna o documento/diretório totalmente editável mas é um risco de segurança, só devendo ser utilizado na instalação do site. <br />
          As recomendações são CHMOD 755 para diretórios, 644 para arquivos e 766 em diretório de Cache e Media.         				
				</td>
			</tr>
			</table>
		<?php
