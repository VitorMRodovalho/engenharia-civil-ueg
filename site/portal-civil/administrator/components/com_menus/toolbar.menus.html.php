...
* @package Joomla / Traduзгo idioma pt-br 27-07-2007 /por: Lena - www.facilhost.com.br
* @subpackage Menus
...
class TOOLBAR_menus {
	...
	*/
	function _NEW()	{
		...
		mosMenuBar::customX( 'edit', 'next.png', 'next_f2.png', 'Prуximo', true );
		mosMenuBar::spacer();
		mosMenuBar::cancel();
		mosMenuBar::spacer();
	...
	*/
	function _MOVEMENU()	{
		mosMenuBar::startTable();
		mosMenuBar::custom( 'movemenusave', 'move.png', 'move_f2.png', 'Mover', false );
		mosMenuBar::spacer();
	...
	*/
	function _COPYMENU()	{
		mosMenuBar::startTable();
		mosMenuBar::custom( 'copymenusave', 'copy.png', 'copy_f2.png', 'Copiar', false );
		mosMenuBar::spacer();
	...
	*/
	...
	function _DEFAULT() {
		...
		mosMenuBar::spacer();
		mosMenuBar::customX( 'movemenu', 'move.png', 'move_f2.png', 'Mover', true );
		mosMenuBar::spacer();
		mosMenuBar::customX( 'copymenu', 'copy.png', 'copy_f2.png', 'Copiar', true );
		mosMenuBar::spacer();
		mosMenuBar::trash();
		mosMenuBar::spacer();
