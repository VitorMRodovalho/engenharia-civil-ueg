<?php
if (!defined('_REM_INTERNAL')) DEFINE('_REM_INTERNAL','Raktár Belsõ Hiba');
...
if (!defined('_MAIN_DOWNLOADS')) DEFINE('_MAIN_DOWNLOADS','Fõraktár Oldala');
if (!defined('_BACK_CAT')) DEFINE('_BACK_CAT','Vissza az elõzõ kategóriába');
if (!defined('_BACK_FOLDER')) DEFINE('_BACK_FOLDER','Vissza az elõzõ könyvtárba');
if (!defined('_DOWN_START')) DEFINE('_DOWN_START','A letöltés 2 másodpercen belül elkezdõdik.');
...
if (!defined('_DOWN_NO_CATS')) DEFINE("_DOWN_NO_CATS","A Raktár még nem készült el a következõn: <i>$mosConfig_sitename</i>.<br/>&nbsp;<br/>Nincs definiálva kategória.");
...
if (!defined('_DOWN_FILE_AUTHOR')) DEFINE('_DOWN_FILE_AUTHOR','File Szerzõje:');
...
if (!defined('_DOWN_SCREEN')) DEFINE('_DOWN_SCREEN','Képernyõkép:');
...
if (!defined('_DOWN_UP_WAIT')) DEFINE('_DOWN_UP_WAIT','Megjegyzés: Minden feltöltés felülvizsgálatra kerül a publikálás elõtt.');
...
if (!defined('_DOWN_FIRST_COMMENT')) DEFINE('_DOWN_FIRST_COMMENT','Legyen az elsõ aki hozzászól!');
if (!defined('_DOWN_FIRST_COMMENT_NL')) DEFINE('_DOWN_FIRST_COMMENT_NL','Legyen az elsõ aki hozzászól! Kérem jelentkezzen be vagy regisztráljon!');
...
if (!defined('_DOWN_MAIL_MSG')) DEFINE('_DOWN_MAIL_MSG','Üdvözlöm. Egy új Letöltés engedélyezés érkezett $user_full-tõl'
...
if (!defined('_DOWN_ORPHAN_FILE_DEL')) DEFINE('_DOWN_ORPHAN_FILE_DEL','Törlendõ file');
if (!defined('_DOWN_ORPHAN_NODEL')) DEFINE('_DOWN_ORPHAN_NODEL','Nincs törlendõ file');
if (!defined('_DOWN_ORPHAN_DONE')) DEFINE('_DOWN_ORPHAN_DONE','Elárvult file-ok törölve');
if (!defined('_DOWN_BAD_POST')) DEFINE('_DOWN_BAD_POST','A beállítások nem lettek megfelelõen elküldve az ûrlapról.');
...
if (!defined('_DOWN_MINI_SCREEN_PROMPT')) DEFINE('_DOWN_MINI_SCREEN_PROMPT','Mini képernyõkép mutatása a file listában:');
...
if (!defined('_DOWN_SEL_CAT_DEL')) DEFINE('_DOWN_SEL_CAT_DEL','Válassza ki a törlendõ kategóriát');
...
if (!defined('_DOWN_SEL_FILE_DEL')) DEFINE('_DOWN_SEL_FILE_DEL','Válassza ki a törlendõ file-t');
...
if (!defined('_DOWN_PARENT_CAT')) DEFINE('_DOWN_PARENT_CAT','Szülõ kategória');
if (!defined('_DOWN_PARENT_FOLDER')) DEFINE('_DOWN_PARENT_FOLDER','Szülõ könyvtár');
...
if (!defined('_DOWN_CONFIG1')) DEFINE("_DOWN_CONFIG1","TabClass:<br/><i>(MOS CSS sorok színe váltakozó (Két vesszõvel elválasztott értékek))</i>");
...
if (!defined('_DOWN_CONFIG6')) DEFINE("_DOWN_CONFIG6","MaxSize:<br/><i>(Maximum feltölthetõ fileméret Kb-ban)</i>");
if (!defined('_DOWN_CONFIG7')) DEFINE("_DOWN_CONFIG7","Max_Up_Per_Day:<br/><i>(Maximum feltölthetõ file-ok száma naponta (Az Adminé korlátlan))</i>");
if (!defined('_DOWN_CONFIG8')) DEFINE("_DOWN_CONFIG8","Max_Up_Dir_Space:<br/><i>(Maximum feltöltés könyvtár méret Kb-ban)</i>");
if (!defined('_DOWN_CONFIG9')) DEFINE("_DOWN_CONFIG9","ExtsOk:<br/><i>(Engedélyezett kiterjesztések feltöltésre (Vesszõvel elválasztott lista))</i>");
if (!defined('_DOWN_CONFIG10')) DEFINE("_DOWN_CONFIG10","Allowed_Desc_Tags:<br/><i>(HTML Tag-ek engedélyezése a leírásban (Vesszõvel elválasztott lista))</i>");
if (!defined('_DOWN_CONFIG11')) DEFINE("_DOWN_CONFIG11","Allow_Up_Overwrite:<br/><i>(Új feltöltések felülírhatják a létezõ file-okat)</i>");
...
if (!defined('_DOWN_CONFIG16')) DEFINE("_DOWN_CONFIG16","Send_Sub_Mail:<br/><i>(Levél küldése az Admin-nak (vagy azzal egyenértékûnek) ha a felhasználó feltölt egy file-t)</i>");
if (!defined('_DOWN_CONFIG17')) DEFINE("_DOWN_CONFIG17","Sub_Mail_Alt_Addr:<br/><i>(Eltérõ Email cím melyre a jóváhagyási igények érkeznek, máskülönban az Admin kapja)</i>");
if (!defined('_DOWN_CONFIG18')) DEFINE("_DOWN_CONFIG18","Sub_Mail_Alt_Name:<br/><i>(Eltérõ címzett név, jóváhagyási figyelmeztetéshez)</i>");
if (!defined('_DOWN_CONFIG19')) DEFINE("_DOWN_CONFIG19","HeaderPic:<br/><i>(Fejléc grafika)</i>");
if (!defined('_DOWN_CONFIG20')) DEFINE("_DOWN_CONFIG20","Anti-Leach:<br/><i>(File-ok elrejtése a közvetlen linkelés megelõzésére)</i>");
if (!defined('_DOWN_CONFIG21')) DEFINE("_DOWN_CONFIG21","Large_Text_Len:<br/><i>(Maximum tárolási méret a hosszú mezõknél (Leírás/Licensz))</i>");
if (!defined('_DOWN_CONFIG22')) DEFINE("_DOWN_CONFIG22","Small_Text_Len:<br/><i>(Maximum tárolási méret a rövid mezõknél)</i>");
if (!defined('_DOWN_CONFIG23')) DEFINE("_DOWN_CONFIG23","Small_Image_Width:<br/><i>(Kis képernyõkép szélesség)</i>");
if (!defined('_DOWN_CONFIG24')) DEFINE("_DOWN_CONFIG24","Small_Image_Height:<br/><i>(Kis képernyõkép magasság)</i>");
...
if (!defined('_DOWN_AUTHOR_ABOUT')) DEFINE('_DOWN_AUTHOR_ABOUT','Szerzõ');
...
if (!defined('_FILE')) DEFINE('_FILE','Feltöltendõ file:');
...
if (!defined('_ERR3')) DEFINE('_ERR3','A feltöltendõ file nulla hosszúságú!');
if (!defined('_ERR4')) DEFINE('_ERR4','A feltöltendõ file kiterjesztése nem megengedett!');
if (!defined('_ERR5')) DEFINE('_ERR5','A feltöltendõ file mérete túllépi a megengedettet: ');
if (!defined('_ERR6')) DEFINE('_ERR6','A feltöltendõ file már létezik. Adjon meg egy új file nevet.');
