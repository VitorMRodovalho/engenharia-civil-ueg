...
class basicHTML {
	...
	function cpanelLink () {
		...
		$imgurl = $interface->getCfg('live_site').'/components/com_remository/images/admin/cpanel.png';
		$link = $interface->getCfg('live_site').'/administrator/index2.php?option=com_remository&amp;act=cpanel';
		?>
		<tr>
			<td><a href='<?php echo $link ?>'><img style='border:0' src='<?php echo $imgurl ?>' /><?php echo ' '._DOWN_CPANEL_RETURN ?></td>
		</tr>
		<?php
	}
		...
		<table cellpadding="4" cellspacing="0" border="0" width="100%">
   		<tr>
			...
			if ($this->act != 'cpanel') {
				...
				echo "<a href='$livesite/administrator/index2.php?option=com_remository&amp;act=cpanel' >";
				echo "<img src='$livesite/administrator/images/cpanel.png' alt='cpanel' style='border:0' />";
				echo "<span class='sectionname'>"._DOWN_CPANEL_RETURN."</span></a>";
			}
			?>
			</div>
			</td>
	...
	function listFormEnd ($pagecontrol=true) {
		if ($pagecontrol) {
			?>
			<tr>
	    		<th align="center" colspan="11"> <?php echo $this->pageNav->writePagesLinks(); ?></th>
			</tr>
			<tr>
				<td align="center" colspan="11"> <?php echo $this->pageNav->writePagesCounter(); ?></td>
			</tr>
			<?php
		}
		?>
