...
class remositoryAddManyFilesDoneHTML extends remositoryUserHTML {
	function addManyFilesDoneHTML (&$files) {
		...
		foreach ($files as $file) {
			if ($file->filetitle<>'') $this->fileListing ($file, null, null, $this->remUser);
		}
		echo "\n\t</div>\n";
